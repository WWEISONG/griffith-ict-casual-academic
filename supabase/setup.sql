...
--
-- This file is generated. It concatenates, in order:
...
--   supabase/seed/0001_courses.sql          187 School of ICT courses
--
-- Safe to re-run: every statement is idempotent.
--
-- Regenerate with:  npm run gen:setup
-- ============================================================================
...
-- ============================================================================
-- Done. You should see the tables under Table Editor.
--
-- Next: fill in .env.local and run `npm run bootstrap` to create the
-- administrator account and open the first recruitment round.
-- ============================================================================
